...
def home(): 
    ...
    if current_user.is_authenticated:
        ...
        return render_template('home.html', created_classes=created_classes,joined_classes=joined_classes, user=user,form=form, username=user.username)
    
    return render_template('home.html', user=user,created_classes=created_classes,joined_classes=joined_classes, form=form, username=user.username)
